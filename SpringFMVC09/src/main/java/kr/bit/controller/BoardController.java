...
public class BoardController {
	...
	@RequestMapping("/list")
	public String getList(Criteria cri, Model model) {//검색기능을 위해 type, keyword 변수를 넘겨받아야함. -> Criteria.class
		// POJO 역할 3가지 
		...
		//검색기능을 위해 totalCount에서 cri를 받아야함.
		pageMaker.setTotalCount(boardService.totalCount(cri)); //전체페이지 수 계산
